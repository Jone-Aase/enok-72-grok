...
1. **Lengdegrader = GE-grid eksakt. Breddegrader = kun Solens 5 ringer.**
   Norge = sann form, festes til 3 ankerpunkter, IKKE strekkes.
2. **Solen lyser ALLTID** (ingen natt-tilstand for sol).
