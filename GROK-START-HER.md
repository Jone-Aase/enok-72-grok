...
4. **Kun Perplexity merger til main.** Andre agenter kan committe direkte til egne navngitte branches (`grok/*`, `chatgpt/*`). `main` er beskyttet — alle endringer må gå via PR, og kun Perplexity merger.
